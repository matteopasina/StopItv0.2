...
public class DailyLeaderboardAdapter extends RecyclerView.Adapter<DailyLeaderboardAdapter.ViewHolder> {

    private final ArrayList<User> mLeaderboard;

    public DailyLeaderboardAdapter(ArrayList<User> leaderboard) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mPoints.setText(""+mLeaderboard.get(position).getDayPoints());
