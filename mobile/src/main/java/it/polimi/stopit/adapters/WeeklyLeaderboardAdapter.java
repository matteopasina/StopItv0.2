...
public class WeeklyLeaderboardAdapter extends RecyclerView.Adapter<WeeklyLeaderboardAdapter.ViewHolder> {

    private final ArrayList<User> mLeaderboard;

    public WeeklyLeaderboardAdapter(ArrayList<User> leaderboard) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mPoints.setText(""+mLeaderboard.get(position).getWeekPoints());
