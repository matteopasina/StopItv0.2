...
public class Challenge implements Serializable{
    ...
    public DataMap putToDataMap(DataMap map) {
        ...
        map.putString("opponentID",this.getOpponentID());
        map.putLong("myPoints",this.getMyPoints());
        map.putLong("opponentPoints",this.getOpponentPoints());
        map.putLong("timeLeft", this.getEndTime()-this.getStartTime());
        return map;
    }
}
